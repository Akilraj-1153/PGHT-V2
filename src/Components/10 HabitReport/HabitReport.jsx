  ...
  return (
    <div className="habit-report text-center  h-full w-full rounded-xl p-2 overflow-hidden ">
        ...
        <h2 className="text-lg font-bold w-fit ">{habit} Report</h2>
                <button className='h-fit w-fit  rounded-md border-2 text-md md:text-2xl font-bold  border-2 border-blue-500 p-2 rounded-md w-fit text-blue-500 hover:bg-blue-500 hover:text-white transition-colors duration-300' onClick={()=>deleteHabit(habit)}>Delete</button>
                <button className='h-fit w-fit  rounded-md border-2 text-md md:text-2xl font-bold  border-2 border-blue-500 p-2 rounded-md w-fit text-blue-500 hover:bg-blue-500 hover:text-white transition-colors duration-300' onClick={()=>setHabitForReport(null)}>Close</button>
            </div>
