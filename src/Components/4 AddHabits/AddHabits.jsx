...
function AddHabits() {
  ...
  return (
    <div className="h-[85%]  w-[95%] justify-center items-center flex-col flex lg:flex-row text-black gap-5">
      <div className='h-auto w-auto rounded-xl border-2 text-white flex flex-col justify-center gap-5 p-2 items-center p-5'>
      <h1 className='text-center'>Select the Habit From Suggetions Or enter Manually</h1>
